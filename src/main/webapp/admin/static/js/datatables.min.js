...
b){g.fn.DataTable[a]=b});return g.fn.dataTable};"function"===typeof define&&define.amd?define("datatables",["src/main/webapp/admin/static/js/jquery"],S):"object"===typeof exports?module.exports=S(require("src/main/webapp/admin/static/js/jquery")):jQuery&&!jQuery.fn.dataTable&&S(jQuery)})(window,document);
...
collection:{container:"DTTT_dropdown dropdown-menu",buttons:{normal:"",disabled:"disabled"}},print:{info:"DTTT_print_info"},select:{row:"active"}}),b.extend(!0,c.TableTools.DEFAULTS.oTags,{collection:{container:"ul",button:"li",liner:"a"}}))};"function"===typeof define&&define.amd?define(["src/main/webapp/admin/static/js/jquery","datatables"],d):"object"===typeof exports?d(require("src/main/webapp/admin/static/js/jquery"),require("datatables")):jQuery&&d(jQuery,jQuery.fn.dataTable)})(window,document);
